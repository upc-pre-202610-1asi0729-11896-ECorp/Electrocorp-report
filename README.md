...
|3  | Nombre: Lourdes<br>Apellido: Saldarriaga <br>Edad: 46<br>Distrito: La Victoria |Lourdes representa a una microempresaria operativa con enfoque en continuidad y seguridad del negocio, que busca:<br>- Reducir riesgos por descuidos<br>- Automatizar procesos clave<br>- Tener mayor control sobre sus equipos<br><br>Está abierta a soluciones tecnológicas, siempre que estas sean:<br>- Económicas<br>- Fáciles de usar<br>- Claras en su beneficio (evitar fallas y ahorrar energía) | <img src="assets/seg2 - img3.png">
