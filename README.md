...
| - | - | - | - | - |
|**EP-01**|**Instalación y configuración inicial**|Como usuario de un hogar o pequeño negocio, quiero instalar y configurar mis dispositivos inteligentes simulados fácilmente para comenzar a usar la solución de forma rápida, práctica y sin necesidad de asistencia técnica especializada.|<p>**Escenario 1: Registro de usuario**</p><p>Dado que el usuario accede a la plataforma por primera vez,</p><p>Cuando completa el formulario de registro con sus datos,</p><p>Entonces el sistema crea su cuenta y le permite iniciar sesión.</p><br><p>**Escenario 2: Vinculación de dispositivo**</p><p>Dado que el usuario ha iniciado sesión,</p><p>Cuando ingresa el código del dispositivo plug-and-play,</p><p>Entonces el sistema vincula el equipo a su cuenta y lo muestra en el dashboard.</p>||
|**EP-02**|**Control y automatización de dispositivos**|Como usuario, quiero controlar y automatizar mis dispositivos eléctricos desde la plataforma para mejorar la comodidad y optimizar el uso de energía.|<p>**Escenario 1: Control Remoto**</p><p>Dado que el usuario está en su panel principal,</p><p>Cuando presiona el botón de encendido/apagado de un dispositivo,</p><p>Entonces el estado del dispositivo cambia físicamente y se refleja en la interfaz.</p><br><p>**Escenario 2: Programación de horarios**</p><p>Dado que el usuario selecciona un dispositivo,</p><p>Cuando define una hora de encendido y apagado automático,</p><p>Entonces el sistema guarda la rutina y la ejecuta puntualmente.</p>||
|**EP-03**|**Monitoreo y ahorro de energía**|Como usuario, quiero visualizar y comparar el consumo de mis dispositivos en tiempo real e histórico para identificar oportunidades de ahorro.|<p>**Escenario 1: Visualización de consumo**</p><p>Dado que el usuario accede a la sección de métricas,</p><p>Cuando visualiza el gráfico de consumo actual,</p><p>Entonces el sistema muestra los Watts consumidos en tiempo real por cada equipo.</p><br><p>**Escenario 2: Reporte Histórico**</p><p>Dado que el usuario solicita el reporte mensual,</p><p>Cuando selecciona el mes de interés,</p><p>Entonces se genera un gráfico comparativo con el consumo acumulado.</p>||
|**EP-04**|**Seguridad, accesos y gestión de usuarios**|Como usuario administrador, quiero controlar los accesos y permisos de quienes usan la plataforma para mantener la seguridad y trazabilidad.|<p>**Escenario 1: Gestión de perfiles**</p><p>Dado que el administrador accede a la sección de familia/empleados,</p><p>Cuando invita a un nuevo correo con un rol específico,</p><p>Entonces se crea un perfil con permisos restringidos según el rol asignado.</p><br><p>**Escenario 2: Auditoría de actividad**</p><p>Dado que un usuario secundario realiza una acción,</p><p>Cuando el administrador revisa el registro,</p><p>Entonces visualiza la fecha, hora y el nombre de quien realizó el cambio.</p>||
|**EP-05**|**Información y Navegación de Landing Page**|Como usuario visitante, deseo acceder a información relevante y navegar fácilmente por la landing page para obtener una comprensión clara de la aplicación.|<p>**Escenario 1: Visualización informativa**</p><p>Dado que un visitante ingresa a la web de ElectroCorp,</p><p>Cuando navega por la página principal,</p><p>Entonces visualiza claramente las características, misión y beneficios del producto.</p><br><p>**Escenario 2: Navegación Responsiva**</p><p>Dado que el visitante usa un dispositivo móvil,</p><p>Cuando interactúa con el menú,</p><p>Entonces la página se adapta correctamente a la resolución de su pantalla.</p>||
|**EP-06**|**Gestión de Suscripciones Premium**|Como usuario, quiero gestionar mi plan de suscripción mediante pasarelas de pago seguras para acceder a funcionalidades avanzadas de ahorro.|<p>**Escenario 1: Adquisición de Plan**</p><p>Dado que el usuario elige un plan premium,</p><p>Cuando ingresa sus datos en la pasarela de Stripe,</p><p>Entonces el pago se procesa y su cuenta adquiere beneficios adicionales inmediatamente.</p>||
|**EP-07**|**Notificaciones y Soporte Técnico**|Como usuario, quiero recibir alertas automatizadas y tener acceso a soporte para resolver dudas técnicas rápidamente.|<p>**Escenario 1: Alerta de Consumo**</p><p>Dado que un dispositivo supera el umbral de Watts configurado,</p><p>Cuando el sistema detecta la anomalía,</p><p>Entonces se envía una notificación push y un correo vía Mailchimp al usuario.</p>||
...
| - | - | - | - | - |
|**US-01**|Registro inicial del usuario|<p>Como usuario del hogar, quiero crear una cuenta en la plataforma para vincular mis dispositivos y acceder a sus funciones.</p>|<p>**Escenario 1:** Registro Exitoso</p><p>Dado que el usuario no tiene cuenta,</p><p>Cuando ingresa su email y contraseña válidos,</p><p>Entonces el sistema crea la cuenta y muestra un mensaje de éxito.</p>|**EP-01**|
|**US-02**|Emparejar dispositivo plug-and-play|<p>Como usuario, quiero vincular un enchufe o interruptor inteligente desde la app para empezar a controlarlo.</p>|<p>**Escenario 1:** Vinculación de hardware simulado</p><p>Dado que el usuario está en la sección de agregar dispositivo,</p><p>Cuando ingresa el código del dispositivo,</p><p>Entonces el equipo aparece en su lista principal listo para ser usado.</p>|**EP-01**|
|**US-03**|Asistente de instalación guiada|<p>Como usuario nuevo, quiero seguir una guía paso a paso para instalar el sistema sin modificar el cableado.</p>|<p>**Escenario 1:** Asistente de primer inicio</p><p>Dado que es el primer login del usuario,</p><p>Cuando el usuario entra a la aplicación,</p><p>Entonces se muestra un tutorial interactivo de 3 pasos para añadir equipos.</p>|**EP-01**|
|**US-04**|Nombrar dispositivos|<p>Como usuario, quiero asignar nombres personalizados a mis dispositivos para identificarlos fácilmente.</p>|<p>**Escenario 1:** Personalización de etiquetas</p><p>Dado que el dispositivo fue vinculado,</p><p>Cuando el usuario edita el nombre a "Refrigeradora",</p><p>Entonces el nuevo nombre se guarda y se muestra en todos los reportes.</p>|**EP-01**|
|**US-05**|Ver estado en tiempo real|<p>Como usuario, quiero ver si un dispositivo está encendido o apagado para saber su estado actual.</p>|<p>**Escenario 1:** Feedback visual de estado</p><p>Dado que el usuario observa su dashboard,</p><p>Cuando un dispositivo simulado se enciende,</p><p>Entonces el icono correspondiente cambia de color a activo.</p>|**EP-02**|
|**US-06**|Encender y apagar remotamente|<p>Como usuario, quiero controlar mis dispositivos desde el celular o la web para usarlos aunque no esté en casa.</p>|<p>**Escenario 1:** Acción remota</p><p>Dado que el dispositivo está apagado,</p><p>Cuando el usuario hace clic en el botón de encender,</p><p>Entonces el sistema envía la señal y el dispositivo se enciende.</p>|**EP-02**|
|**US-07**|Programar horarios de encendido|<p>Como usuario, quiero programar horarios automáticos para reducir consumo y tener mayor comodidad.</p>|<p>**Escenario 1:** Creación de horario</p><p>Dado que el usuario selecciona un enchufe,</p><p>Cuando configura que se encienda de 18:00 a 22:00,</p><p>Entonces el sistema respeta el horario diariamente.</p>|**EP-02**|
|**US-08**|Crear rutinas automáticas|<p>Como usuario, quiero definir rutinas como "siempre apagar a cierta hora" para automatizar tareas repetitivas.</p>|<p>**Escenario 1:** Rutina nocturna</p><p>Dado que el usuario crea una rutina "Dormir",</p><p>Cuando llega la hora programada,</p><p>Entonces todos los dispositivos seleccionados se apagan a la vez.</p>|**EP-02**|
|**US-09**|Ver consumo en tiempo real|<p>Como usuario, quiero monitorear el consumo energético de mis dispositivos en tiempo real para entender cuánto gasto.</p>|<p>**Escenario 1:** Monitor de Watts</p><p>Dado que el enchufe está activo,</p><p>Cuando el usuario abre la gráfica en vivo,</p><p>Entonces visualiza los Watts consumidos actualizados constantemente.</p>|**EP-03**|
|**US-10**|Consultar historial de consumo|<p>Como usuario, quiero revisar el historial de consumo por día, semana o mes para identificar patrones de uso.</p>|<p>**Escenario 1:** Filtro de historial</p><p>Dado que el usuario está en reportes,</p><p>Cuando selecciona "Últimos 7 días",</p><p>Entonces se muestra un gráfico de barras con el consumo diario.</p>|**EP-03**|
|**US-11**|Recibir alertas por alto consumo|<p>Como usuario, quiero recibir alertas cuando un dispositivo consuma más de lo normal para evitar gastos innecesarios.</p>|<p>**Escenario 1:** Alerta en app</p><p>Dado que el límite configurado es 500W,</p><p>Cuando un equipo supera ese límite,</p><p>Entonces aparece una notificación push en el celular del usuario.</p>|**EP-03**|
|**US-12**|Ver recomendaciones de ahorro|<p>Como usuario, quiero recibir sugerencias para ahorrar energía según mi consumo habitual.</p>|<p>**Escenario 1:** Tips del sistema</p><p>Dado que el usuario deja un equipo encendido de madrugada,</p><p>Cuando revisa el panel de sugerencias,</p><p>Entonces el sistema recomienda crear una rutina de apagado nocturno.</p>|**EP-03**|
|**US-13**|Administrar múltiples dispositivos|<p>Como usuario, quiero visualizar todos mis dispositivos en una sola pantalla para gestionarlos fácilmente.</p>|<p>**Escenario 1:** Lista general</p><p>Dado que el usuario tiene 5 dispositivos,</p><p>Cuando ingresa al inicio,</p><p>Entonces visualiza los 5 dispositivos en forma de tarjetas operables.</p>|**EP-04**|
|**US-14**|Crear perfiles de acceso|<p>Como usuario administrador, quiero dar acceso a otros miembros de la familia con permisos limitados.</p>|<p>**Escenario 1:** Rol de invitado</p><p>Dado que el administrador invita a un usuario secundario,</p><p>Cuando este inicia sesión,</p><p>Entonces solo puede operar dispositivos, pero no borrarlos ni configurarlos.</p>|**EP-04**|
|**US-15**|Bloquear acceso no autorizado|<p>Como usuario, quiero proteger mi cuenta para que nadie controle mis dispositivos sin permiso.</p>|<p>**Escenario 1:** Cierre por inactividad</p><p>Dado que el usuario deja la app web abierta,</p><p>Cuando pasan 30 minutos de inactividad,</p><p>Entonces la sesión expira automáticamente.</p>|**EP-04**|
|**US-16**|Registrar actividad de control|<p>Como usuario administrador, quiero ver quién encendió o apagó un equipo para tener trazabilidad.</p>|<p>**Escenario 1:** Log de auditoría</p><p>Dado que se ejecutó una acción manual,</p><p>Cuando el administrador entra al registro,</p><p>Entonces ve el detalle del evento y qué usuario lo ejecutó.</p>|**EP-04**|
|**US-17**|Controlar equipos del negocio|<p>Como dueño de negocio, quiero encender o apagar equipos del local desde mi móvil para ahorrar tiempo.</p>|<p>**Escenario 1:** Control a distancia</p><p>Dado que el dueño está fuera de su local,</p><p>Cuando presiona el botón de apagar iluminación general,</p><p>Entonces la acción se refleja de inmediato en los equipos del negocio.</p>|**EP-02**|
|**US-18**|Programar equipos por horario comercial|<p>Como dueño de negocio, quiero automatizar el encendido según el horario de atención.</p>|<p>**Escenario 1:** Horario comercial</p><p>Dado que el horario es 9am a 6pm,</p><p>Cuando se programa la automatización principal,</p><p>Entonces los equipos se activan a las 9am y se apagan a las 6pm.</p>|**EP-02**|
|**US-19**|Revisar consumo por área o equipo|<p>Como dueño de negocio, quiero identificar qué equipos consumen más energía.</p>|<p>**Escenario 1:** Desglose por equipo</p><p>Dado que hay múltiples equipos registrados,</p><p>Cuando revisa el reporte mensual,</p><p>Entonces visualiza un gráfico con el porcentaje de gasto de cada uno.</p>|**EP-03**|
|**US-20**|Compartir acceso con personal|<p>Como dueño de negocio, quiero permitir que ciertos empleados controlen solo algunos dispositivos.</p>|<p>**Escenario 1:** Permisos específicos</p><p>Dado que un empleado tiene acceso restringido,</p><p>Cuando ingresa a la app,</p><p>Entonces solo visualiza y controla los dispositivos de su área asignada.</p>|**EP-04**|
|**US-21**|Visualizar página informativa|<p>Como usuario visitante, quiero acceder a una landing page para conocer de qué trata ElectroCorp.</p>|<p>**Escenario 1:** Carga de página</p><p>Dado que el usuario ingresa la URL oficial,</p><p>Cuando carga la web,</p><p>Entonces visualiza la propuesta de valor y las secciones principales.</p>|**EP-05**|
|**US-22**|Landing page intuitiva|<p>Como usuario visitante, quiero navegar fácilmente por las secciones de la página para encontrar información rápido.</p>|<p>**Escenario 1:** Uso de enlaces ancla</p><p>Dado que el usuario quiere ver los precios,</p><p>Cuando hace clic en "Planes" en el menú de navegación,</p><p>Entonces la pantalla realiza un scroll suave hacia esa sección.</p>|**EP-05**|
|**US-23**|Landing page responsiva|<p>Como usuario visitante, quiero que la página se adapte a mi celular para leerla cómodamente.</p>|<p>**Escenario 1:** Vista en dispositivo móvil</p><p>Dado que el usuario entra desde un smartphone,</p><p>Cuando visualiza el contenido,</p><p>Entonces los elementos se organizan verticalmente de forma óptima.</p>|**EP-05**|
|**US-24**|Ver planes de suscripción|<p>Como usuario visitante, quiero comparar los planes gratuitos y premium para decidir si me registro.</p>|<p>**Escenario 1:** Tabla comparativa</p><p>Dado que el usuario navega a la sección de planes,</p><p>Cuando revisa la tabla,</p><p>Entonces ve listadas las diferencias claras de funcionalidades entre cada plan.</p>|**EP-05**|
|**US-25**|Pagar suscripción con tarjeta|<p>Como usuario, quiero ingresar mi tarjeta de crédito de forma segura para adquirir el plan Premium.</p>|<p>**Escenario 1:** Integración Stripe</p><p>Dado que el usuario elige un plan Premium,</p><p>Cuando ingresa sus datos y confirma,</p><p>Entonces la pasarela procesa el pago y la cuenta se actualiza en la base de datos.</p>|**EP-06**|
|**US-26**|Cancelar suscripción Premium|<p>Como usuario, quiero anular mi suscripción para que no me cobren el siguiente mes.</p>|<p>**Escenario 1:** Proceso de anulación</p><p>Dado que el usuario accede a su configuración de pago,</p><p>Cuando confirma la cancelación del servicio,</p><p>Entonces el sistema programa la baja para el siguiente ciclo de facturación.</p>|**EP-06**|
|**US-27**|Recibir alertas por correo|<p>Como usuario, quiero que el sistema me notifique a mi correo si ocurre un pico inusual de consumo.</p>|<p>**Escenario 1:** Envío automático</p><p>Dado que se detecta una anomalía crítica,</p><p>Cuando el backend procesa la regla,</p><p>Entonces se dispara el envío de un correo de alerta mediante la API externa.</p>|**EP-07**|
|**US-28**|Recibir reporte mensual de consumo|<p>Como usuario, quiero recibir un resumen mensual en mi email para conocer mi evolución de gasto.</p>|<p>**Escenario 1:** Generación de reporte</p><p>Dado que finaliza el mes calendario,</p><p>Cuando el sistema realiza el corte mensual,</p><p>Entonces consolida la información y envía el reporte al correo registrado.</p>|**EP-07**|
|**US-29**|Recuperar contraseña|<p>Como usuario, quiero poder restablecer mi contraseña si la olvido para recuperar mi acceso.</p>|<p>**Escenario 1:** Flujo de recuperación</p><p>Dado que el usuario solicita restablecer su clave,</p><p>Cuando ingresa su correo electrónico válido,</p><p>Entonces recibe un enlace con un token de un solo uso para crear una nueva.</p>|**EP-04**|
|**US-30**|Editar perfil de usuario|<p>Como usuario, quiero modificar mi información personal para mantener mi perfil actualizado.</p>|<p>**Escenario 1:** Actualización de datos</p><p>Dado que el usuario accede a la edición de perfil,</p><p>Cuando modifica su nombre o número y guarda,</p><p>Entonces los cambios se reflejan inmediatamente en la interfaz.</p>|**EP-04**|
|**US-31**|Eliminar cuenta|<p>Como usuario, quiero borrar definitivamente mi cuenta y mis datos de la plataforma.</p>|<p>**Escenario 1:** Borrado permanente</p><p>Dado que el usuario confirma su deseo de eliminar la cuenta,</p><p>Cuando el sistema valida la acción,</p><p>Entonces purga toda su información de usuario y configuraciones de la base de datos.</p>|**EP-04**|
|**US-32**|Configurar preferencias de notificaciones|<p>Como usuario, quiero elegir qué tipo de alertas recibir para personalizar mi experiencia.</p>|<p>**Escenario 1:** Ajustes de notificaciones</p><p>Dado que el usuario accede a configuración de alertas,</p><p>Cuando desmarca la opción de recibir correos de reportes,</p><p>Entonces el sistema excluye su correo del envío mensual.</p>|**EP-07**|
|**US-33**|Simular conexión de nuevo dispositivo|<p>Como tester o desarrollador, quiero simular que un nuevo equipo es conectado a la red eléctrica.</p>|<p>**Escenario 1:** Evento de simulación</p><p>Dado que la plataforma opera con dispositivos virtuales,</p><p>Cuando se envía el evento de registro simulado al backend,</p><p>Entonces el nuevo dispositivo aparece disponible en el listado del frontend.</p>|**EP-01**|
|**US-34**|Simular desconexión de dispositivo|<p>Como usuario, quiero identificar en la interfaz si un equipo simulado perdió conexión.</p>|<p>**Escenario 1:** Estado offline</p><p>Dado que se interrumpe la simulación de telemetría de un equipo,</p><p>Cuando la API no recibe datos en el tiempo esperado,</p><p>Entonces el ícono del dispositivo se actualiza visualmente a estado desconectado.</p>|**EP-01**|
|**US-35**|Filtrar historial por fechas|<p>Como usuario, quiero establecer un rango de fechas para analizar consumos específicos.</p>|<p>**Escenario 1:** Uso de Datepicker</p><p>Dado que el usuario se encuentra en el historial,</p><p>Cuando selecciona un rango específico en el calendario,</p><p>Entonces la gráfica y los datos se recalculan solo para ese periodo.</p>|**EP-03**|
|**US-36**|Exportar historial a CSV|<p>Como usuario de negocio, quiero descargar mis datos para analizarlos de forma externa.</p>|<p>**Escenario 1:** Descarga de archivo</p><p>Dado que el usuario visualiza una tabla de registros,</p><p>Cuando presiona el botón de exportación,</p><p>Entonces el navegador descarga un archivo formato CSV con la información mostrada.</p>|**EP-03**|
|**US-37**|Acceder a Preguntas Frecuentes|<p>Como usuario, quiero leer respuestas a problemas comunes para autogestionar mis dudas.</p>|<p>**Escenario 1:** Sección de ayuda</p><p>Dado que el usuario accede al Centro de Soporte,</p><p>Cuando despliega una categoría de FAQ,</p><p>Entonces visualiza la respuesta detallada al problema planteado.</p>|**EP-07**|
|**US-38**|Cambiar idioma de la plataforma|<p>Como usuario, quiero elegir entre distintos idiomas para entender mejor la interfaz.</p>|<p>**Escenario 1:** Internacionalización</p><p>Dado que el usuario despliega el menú de idiomas,</p><p>Cuando selecciona una opción distinta,</p><p>Entonces todos los componentes de texto se traducen automáticamente.</p>|**EP-05**|
|**US-39**|Visualizar proyecciones de gasto|<p>Como usuario, quiero ver un estimado de costo monetario basado en mi consumo.</p>|<p>**Escenario 1:** Cálculo de tarifa</p><p>Dado que la plataforma conoce la tarifa promedio por kWh,</p><p>Cuando calcula el consumo actual,</p><p>Entonces muestra una proyección estimada del costo en moneda local.</p>|**EP-03**|
|**US-40**|Agrupar dispositivos por zonas|<p>Como usuario, quiero organizar mis equipos por habitaciones o zonas físicas.</p>|<p>**Escenario 1:** Creación de grupos</p><p>Dado que el usuario tiene múltiples dispositivos,</p><p>Cuando crea un grupo y asigna equipos,</p><p>Entonces puede enviar un comando de apagado general para todos los integrantes de ese grupo.</p>|**EP-02**|
...
| - | - | - | - | - |
|**TS-01**|Maquetación HTML inicial|<p>**Como** desarrollador frontend,</p><p>**Quiero** estructurar el esqueleto HTML de la landing page,</p><p>**Para** asegurar la semántica web (relacionado a US-21).</p>|<p>**Escenario 1: Estructura base**</p><p>Dado que se inicia el desarrollo de la vista principal,</p><p>Cuando se codifica el archivo base,</p><p>Entonces contiene etiquetas semánticas (header, nav, main, footer) correctamente organizadas.</p>|**EP-05**|
|**TS-02**|Estilización general|<p>**Como** diseñador UI/UX,</p><p>**Quiero** aplicar la hoja de estilos CSS a la landing page,</p><p>**Para** reflejar la identidad visual de la marca (relacionado a US-21).</p>|<p>**Escenario 1: Aplicación de estilos**</p><p>Dado que el HTML se encuentra estructurado,</p><p>Cuando se vinculan las clases de estilo globales,</p><p>Entonces los componentes visuales coinciden con las especificaciones del diseño original.</p>|**EP-05**|
|**TS-03**|Diseño de navegación|<p>**Como** desarrollador frontend,</p><p>**Quiero** construir la estructura del menú de navegación,</p><p>**Para** facilitar la movilidad por las secciones (relacionado a US-22).</p>|<p>**Escenario 1: Enlaces funcionales**</p><p>Dado que se ha creado el componente de cabecera,</p><p>Cuando se implementan los enlaces internos,</p><p>Entonces al dar clic redirigen exactamente a la sección correspondiente de la página.</p>|**EP-05**|
|**TS-04**|Personalización del Navbar|<p>**Como** desarrollador UI,</p><p>**Quiero** implementar un cambio visual en el navbar al hacer scroll,</p><p>**Para** mejorar la visibilidad y estética (relacionado a US-22).</p>|<p>**Escenario 1: Efecto Scroll**</p><p>Dado que el usuario navega hacia abajo en la página,</p><p>Cuando se detecta el evento de scroll superior a un umbral definido,</p><p>Entonces se añade dinámicamente una clase CSS que altera el fondo y sombra del navbar.</p>|**EP-05**|
|**TS-05**|Adaptar contenido principal|<p>**Como** desarrollador web,</p><p>**Quiero** utilizar media queries o Flexbox/Grid,</p><p>**Para** garantizar la correcta visualización en distintas pantallas (relacionado a US-23).</p>|<p>**Escenario 1: Comportamiento Responsive**</p><p>Dado que la vista se carga en una resolución menor a 768px,</p><p>Cuando el motor del navegador renderiza los contenedores,</p><p>Entonces las columnas ajustan su disposición de horizontal a vertical ocupando el ancho total.</p>|**EP-05**|
|**TS-06**|Navbar adaptable|<p>**Como** desarrollador frontend,</p><p>**Quiero** implementar un menú colapsable (tipo hamburguesa) para móviles,</p><p>**Para** optimizar el espacio en pantalla (relacionado a US-23).</p>|<p>**Escenario 1: Menú móvil**</p><p>Dado que el ancho de la ventana corresponde a un dispositivo móvil,</p><p>Cuando el usuario interactúa con el ícono de menú,</p><p>Entonces se despliega una lista de opciones que no interfiere con el contenido subyacente.</p>|**EP-05**|
|**TS-07**|Configurar API Spring Boot|<p>**Como** backend developer,</p><p>**Quiero** inicializar la arquitectura del proyecto en Java Spring Boot,</p><p>**Para** establecer la base de la lógica del sistema.</p>|<p>**Escenario 1: Arranque del servidor**</p><p>Dado que se configuran las dependencias iniciales,</p><p>Cuando se compila y ejecuta el proyecto,</p><p>Entonces el servidor de aplicaciones levanta en el puerto designado sin mostrar excepciones de configuración.</p>|**EP-01**|
|**TS-08**|Setup Base de Datos MySQL|<p>**Como** Database Admin o Backend Developer,</p><p>**Quiero** configurar el dialecto y la conexión JPA hacia MySQL,</p><p>**Para** habilitar la persistencia de las entidades del dominio.</p>|<p>**Escenario 1: Conexión a Base de Datos**</p><p>Dado que el motor MySQL se encuentra en ejecución,</p><p>Cuando la aplicación inicia con las credenciales correctas,</p><p>Entonces Hibernate valida la conexión y crea la estructura de tablas inicial según las entidades definidas.</p>|**EP-01**|
|**TS-09**|Integración API de Pagos|<p>**Como** backend developer,</p><p>**Quiero** implementar el cliente HTTP para conectar con la API de Stripe,</p><p>**Para** procesar de manera segura la validación de suscripciones.</p>|<p>**Escenario 1: Comunicación exitosa**</p><p>Dado que se cuenta con el token de prueba de la pasarela,</p><p>Cuando el backend realiza un request de creación de cargo,</p><p>Entonces recibe y procesa correctamente el payload de respuesta confirmando la transacción.</p>|**EP-06**|
|**TS-10**|Integración API Notificaciones|<p>**Como** backend developer,</p><p>**Quiero** configurar las credenciales y el conector REST para Mailchimp,</p><p>**Para** posibilitar el envío asíncrono de correos electrónicos.</p>|<p>**Escenario 1: Envío de correo**</p><p>Dado que se invoca el servicio interno de notificaciones,</p><p>Cuando se arma el payload con el template y el destinatario,</p><p>Entonces la llamada externa finaliza exitosamente añadiendo el mensaje a la cola de envío del proveedor.</p>|**EP-07**|
|**TS-11**|Simulación Lógica de Telemetría|<p>**Como** backend developer,</p><p>**Quiero** implementar una tarea programada (cronjob),</p><p>**Para** simular el registro de consumo de energía en los dispositivos registrados.</p>|<p>**Escenario 1: Generación de datos sintéticos**</p><p>Dado que el planificador de tareas está activo,</p><p>Cuando transcurre el intervalo de tiempo definido,</p><p>Entonces el proceso genera e inserta registros de medición en la base de datos simulando la actividad del dispositivo.</p>|**EP-03**|
|**TS-12**|Desarrollar Endpoints de Dispositivos|<p>**Como** backend developer,</p><p>**Quiero** programar los controladores REST para las operaciones CRUD de los equipos,</p><p>**Para** que la aplicación cliente pueda gestionar el estado de los mismos.</p>|<p>**Escenario 1: Respuesta del Controlador**</p><p>Dado que las rutas están definidas y mapeadas,</p><p>Cuando el cliente web ejecuta una petición GET hacia la ruta de dispositivos,</p><p>Entonces el servidor responde con un status 200 y el listado formateado en JSON.</p>|**EP-02**|
|**TS-13**|Setup Angular SPA|<p>**Como** frontend developer,</p><p>**Quiero** estructurar el proyecto base de Angular y definir el ruteo inicial,</p><p>**Para** habilitar la navegación interactiva sin recarga de página.</p>|<p>**Escenario 1: Compilación de la SPA**</p><p>Dado que se ha clonado el repositorio base,</p><p>Cuando se instalan las dependencias y se lanza el servidor de desarrollo,</p><p>Entonces la aplicación compila exitosamente mostrando el componente principal en el navegador.</p>|**EP-01**|
|**TS-14**|Autenticación y Autorización JWT|<p>**Como** desarrollador fullstack,</p><p>**Quiero** implementar la emisión y validación de tokens JWT,</p><p>**Para** securizar los endpoints privados de la aplicación.</p>|<p>**Escenario 1: Validación de Token**</p><p>Dado que un cliente anónimo intenta acceder a una ruta protegida,</p><p>Cuando la petición no incluye el header de autorización válido,</p><p>Entonces el filtro de seguridad intercepta y rechaza la solicitud con un código HTTP 401.</p>|**EP-04**|
|**TS-15**|Implementación de Gráficos|<p>**Como** frontend developer,</p><p>**Quiero** integrar y configurar una librería de visualización de datos (ej. Chart.js),</p><p>**Para** representar el consumo eléctrico de forma amigable.</p>|<p>**Escenario 1: Renderizado de datos**</p><p>Dado que el componente recibe el conjunto de datos procesado del backend,</p><p>Cuando se invoca el método de dibujo del canvas,</p><p>Entonces se genera visualmente la gráfica correspondiente reflejando las métricas obtenidas.</p>|**EP-03**|
|**TS-16**|Configuración Endpoints Perfil|<p>**Como** backend developer,</p><p>**Quiero** desarrollar el caso de uso y el controlador para modificar datos del usuario,</p><p>**Para** dar soporte a la gestión del perfil desde el frontend.</p>|<p>**Escenario 1: Actualización de datos**</p><p>Dado que el payload de la solicitud contiene datos validados,</p><p>Cuando se procesa el método de actualización del servicio,</p><p>Entonces se altera el registro específico en la tabla de usuarios y se retorna confirmación de la operación.</p>|**EP-04**|
