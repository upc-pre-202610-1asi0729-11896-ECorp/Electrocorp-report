...
|--|--|--|
| Comunica oralmente con efectividad a diferentes rangos de audiencia. | Sebastian Tavara <br>TB1: Realizo entrevistas clave para poder entender al usuario<br> TP1: <br> TB2: <br> TF1: <br> <br> Diego Cabrejos <br>TB1: Expuso la estructura y los avances del desarrollo de la Landing Page durante las reuniones del equipo<br> TP1: <br> TB2: <br> TF1: <br> <br> Jean Loa <br> TB1: <br> TP1: <br> TB2: <br> TF1: <br> Timothy Documet <br>TB1 Realizo entrevidtas clave psra el proyecto asi como las user story, el product bscklog y el ubiqutois lenguage br> TP1: <br> TB2: <br> TF1:|	Sebastian Tavara <br> Fue muy interesante poder estar cerca al usuario y poder tener una mejor vision del problema al que nos enfrentabamos. |
