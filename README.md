...
| - | - | - | - | - |
|**US-01**|Registro inicial del usuario|<p>Como usuario del hogar, quiero crear una cuenta en la plataforma para vincular mis dispositivos.</p>|<p>**Escenario 1:** Registro Exitoso</p><p>Dado que el usuario no tiene cuenta,</p><p>Cuando ingresa su email y contraseña,</p><p>Entonces el sistema crea la cuenta.</p>|**EP-01**|
|**US-02**|Emparejar dispositivo plug-and-play|<p>Como usuario, quiero vincular un enchufe inteligente desde la app.</p>|<p>**Escenario 1:** Vinculación exitosa</p><p>Dado que el usuario está en "Agregar",</p><p>Cuando ingresa el código del equipo,</p><p>Entonces el equipo aparece en su lista.</p>|**EP-01**|
|**US-03**|Asistente de instalación guiada|<p>Como usuario nuevo, quiero seguir una guía paso a paso para instalar el sistema.</p>|<p>**Escenario 1:** Guía de inicio</p><p>Dado que es el primer inicio de sesión,</p><p>Cuando el usuario entra a la app,</p><p>Entonces se muestra un tutorial de 3 pasos.</p>|**EP-01**|
|**US-04**|Nombrar dispositivos|<p>Como usuario, quiero asignar nombres personalizados a mis dispositivos.</p>|<p>**Escenario 1:** Edición de nombre</p><p>Dado que el equipo fue vinculado,</p><p>Cuando el usuario edita el nombre a "Lámpara",</p><p>Entonces el nuevo nombre se guarda.</p>|**EP-01**|
|**US-05**|Ver estado en tiempo real|<p>Como usuario, quiero ver si un dispositivo está encendido o apagado.</p>|<p>**Escenario 1:** Reflejo de estado</p><p>Dado que el usuario observa el dashboard,</p><p>Cuando un equipo cambia de estado,</p><p>Entonces el icono se actualiza.</p>|**EP-02**|
|**US-06**|Encender y apagar remotamente|<p>Como usuario, quiero controlar mis dispositivos desde el celular.</p>|<p>**Escenario 1:** Acción remota</p><p>Dado que el equipo está apagado,</p><p>Cuando el usuario hace clic en encender,</p><p>Entonces el dispositivo cambia a ON.</p>|**EP-02**|
|**US-07**|Programar horarios de encendido|<p>Como usuario, quiero programar horarios automáticos.</p>|<p>**Escenario 1:** Creación de horario</p><p>Dado que el usuario selecciona un enchufe,</p><p>Cuando configura la hora de encendido,</p><p>Entonces el sistema respeta el horario.</p>|**EP-02**|
|**US-08**|Crear rutinas automáticas|<p>Como usuario, quiero definir rutinas de automatización.</p>|<p>**Escenario 1:** Rutina nocturna</p><p>Dado que el usuario crea una rutina "Dormir",</p><p>Cuando llega la hora,</p><p>Entonces todos los dispositivos se apagan.</p>|**EP-02**|
|**US-09**|Ver consumo en tiempo real|<p>Como usuario, quiero monitorear el consumo energético en vivo.</p>|<p>**Escenario 1:** Monitor de Watts</p><p>Dado que el enchufe está activo,</p><p>Cuando el usuario abre la gráfica,</p><p>Entonces visualiza los Watts consumidos.</p>|**EP-03**|
|**US-10**|Consultar historial de consumo|<p>Como usuario, quiero revisar el historial de consumo por día o semana.</p>|<p>**Escenario 1:** Filtro de historial</p><p>Dado que el usuario está en reportes,</p><p>Cuando selecciona "Últimos 7 días",</p><p>Entonces se muestra un gráfico diario.</p>|**EP-03**|
|**US-11**|Recibir alertas por alto consumo|<p>Como usuario, quiero recibir alertas por consumos inusuales.</p>|<p>**Escenario 1:** Alerta en app</p><p>Dado que el límite es 500W,</p><p>Cuando se supera la cifra,</p><p>Entonces aparece una notificación push.</p>|**EP-03**|
|**US-12**|Ver recomendaciones de ahorro|<p>Como usuario, quiero recibir sugerencias para ahorrar energía.</p>|<p>**Escenario 1:** Tips del sistema</p><p>Dado que el consumo es ineficiente,</p><p>Cuando revisa el panel de sugerencias,</p><p>Entonces el sistema recomienda rutinas.</p>|**EP-03**|
|**US-13**|Administrar múltiples dispositivos|<p>Como usuario, quiero visualizar todos mis dispositivos en una sola pantalla.</p>|<p>**Escenario 1:** Lista general</p><p>Dado que el usuario tiene 5 equipos,</p><p>Cuando ingresa al inicio,</p><p>Entonces visualiza los 5 operables.</p>|**EP-04**|
|**US-14**|Crear perfiles de acceso|<p>Como administrador, quiero dar acceso a familiares con permisos limitados.</p>|<p>**Escenario 1:** Rol de invitado</p><p>Dado que el administrador invita a un familiar,</p><p>Cuando inicia sesión,</p><p>Entonces solo puede apagar/encender equipos.</p>|**EP-04**|
|**US-15**|Bloquear acceso no autorizado|<p>Como usuario, quiero proteger mi cuenta de extraños.</p>|<p>**Escenario 1:** Inactividad</p><p>Dado que la app web queda abierta,</p><p>Cuando pasan 30 minutos sin uso,</p><p>Entonces la sesión expira.</p>|**EP-04**|
|**US-16**|Registrar actividad de control|<p>Como administrador, quiero ver quién controló un equipo.</p>|<p>**Escenario 1:** Log de auditoría</p><p>Dado que se ejecutó una acción,</p><p>Cuando se revisa el log,</p><p>Entonces se detalla el nombre del usuario y la hora.</p>|**EP-04**|
|**US-17**|Controlar equipos del negocio|<p>Como dueño de negocio, quiero controlar equipos del local desde mi móvil.</p>|<p>**Escenario 1:** Control a distancia</p><p>Dado que el dueño está en casa,</p><p>Cuando apaga el grupo de luz comercial,</p><p>Entonces se refleja en el local.</p>|**EP-02**|
|**US-18**|Programar equipos por horario comercial|<p>Como dueño, quiero automatizar el local según atención.</p>|<p>**Escenario 1:** Horario comercial</p><p>Dado que el horario es de 9am a 6pm,</p><p>Cuando se programa la rutina general,</p><p>Entonces los equipos siguen el horario.</p>|**EP-02**|
|**US-19**|Revisar consumo por área o equipo|<p>Como dueño, quiero identificar qué equipos consumen más.</p>|<p>**Escenario 1:** Desglose</p><p>Dado que hay varios equipos,</p><p>Cuando revisa el reporte,</p><p>Entonces visualiza un gráfico por zonas.</p>|**EP-03**|
|**US-20**|Compartir acceso con personal|<p>Como dueño, quiero permitir que empleados controlen ciertos equipos.</p>|<p>**Escenario 1:** Permisos por equipo</p><p>Dado que un empleado de limpieza entra a la app,</p><p>Cuando visualiza el dashboard,</p><p>Entonces solo ve el control de luces.</p>|**EP-04**|
|**US-21**|Visualización de la Historia de la Startup|<p>**Como** usuario visitante, **quiero** poder acceder a la historia, misión y visión desde la landing page **para** estar informado acerca de ElectroCorp.</p>|<p>**Escenario 1: Acceso a la historia de ElectroCorp**</p><p>Dado que soy un visitante,</p><p>Cuando navegue y encuentre “Quiénes Somos”,</p><p>Entonces podré obtener información detallada.</p><p>**Escenario 2: Redes sociales**</p><p>Dado que el visitante hace clic en “Contáctanos”,</p><p>Cuando presiona un logo social,</p><p>Entonces es redireccionado a la red correspondiente.</p>|**EP-05**|
|**US-22**|Visualizar las características clave|<p>**Como** usuario visitante, **quiero** poder conocer las características clave **para** saber qué incluye la plataforma.</p>|<p>**Escenario 1: Secciones principales**</p><p>Dado que el visitante está en la landing,</p><p>Cuando se dirige a “Soluciones”,</p><p>Entonces visualiza lo que puede realizar.</p><p>**Escenario 2: Automatización**</p><p>Dado que explora el sitio,</p><p>Cuando lee los beneficios,</p><p>Entonces comprende cómo automatizar sus equipos.</p>|**EP-05**|
|**US-23**|Formulario de contacto|<p>**Como** usuario visitante, **quiero** llenar un formulario con mi información **para** recibir noticias de ElectroCorp.</p>|<p>**Escenario 1: Información en el formulario**</p><p>Dado que deseo contactar,</p><p>Cuando veo la sección del formulario,</p><p>Entonces puedo colocar nombre y correo.</p><p>**Escenario 2: Envío exitoso**</p><p>Dado que completé los datos,</p><p>Cuando doy clic a "ENVIAR",</p><p>Entonces veo un mensaje de éxito.</p>|**EP-05**|
|**US-24**|Ver los planes y precios|<p>Como usuario visitante, quiero tener acceso a una sección que detalle los planes para evaluar mis opciones.</p>|<p>**Escenario 1: Acceso a la sección de planes:**</p><p>Dado que el usuario visita la landing,</p><p>Cuando busque información de costos,</p><p>Entonces encontrará una sección detallada.</p><p>**Escenario 2: Comparación de planes:**</p><p>Dado que revisa los precios,</p><p>Cuando compara opciones,</p><p>Entonces evalúa qué plan de monitoreo necesita.</p>|**EP-05**|
|**US-25**|Navegación en la Landing Page|<p>**Como** usuario visitante, **quiero** contar con un menú visible y funcional **para** desplazarme fácilmente.</p>|<p>**Escenario 1: Acceder a información**</p><p>Dado que el usuario está en la página,</p><p>Cuando le da clic a “¿Quiénes somos?”,</p><p>Entonces es redireccionado a esa sección.</p><p>**Escenario 2: Buscar Contacto**</p><p>Dado que quiere enviar un mensaje,</p><p>Cuando presiona "Contáctanos" en el menú,</p><p>Entonces baja rápidamente al formulario.</p>|**EP-05**|
|**US-26**|Pagar suscripción con tarjeta|<p>Como usuario, quiero ingresar mi tarjeta de forma segura para adquirir el plan Premium.</p>|<p>**Escenario 1:** Pasarela Stripe</p><p>Dado que el usuario elige Premium,</p><p>Cuando ingresa sus datos válidos,</p><p>Entonces Stripe procesa el pago.</p>|**EP-06**|
|**US-27**|Cancelar suscripción Premium|<p>Como usuario, quiero anular mi suscripción para detener cobros.</p>|<p>**Escenario 1:** Cancelación</p><p>Dado que el usuario accede a Mi Plan,</p><p>Cuando confirma la cancelación,</p><p>Entonces el servicio queda programado para anularse.</p>|**EP-06**|
|**US-28**|Recibir alertas por correo|<p>Como usuario, quiero que el sistema me notifique a mi correo si algo inusual pasa con mi consumo.</p>|<p>**Escenario 1:** Envío vía Mailchimp</p><p>Dado que hay un pico de consumo,</p><p>Cuando el backend lo detecta,</p><p>Entonces recibo un email de alerta.</p>|**EP-07**|
|**US-29**|Recibir reporte mensual|<p>Como usuario, quiero recibir un resumen mensual en mi email para saber cuánto ahorré.</p>|<p>**Escenario 1:** Reporte automático</p><p>Dado que finaliza el mes,</p><p>Cuando el sistema hace el corte,</p><p>Entonces me envía un correo con mis gráficas.</p>|**EP-07**|
|**US-30**|Recuperar contraseña|<p>Como usuario, quiero poder restablecer mi contraseña si la olvido.</p>|<p>**Escenario 1:** Envío de token</p><p>Dado que hace clic en recuperar clave,</p><p>Cuando ingresa su email,</p><p>Entonces recibe un enlace seguro.</p>|**EP-04**|
|**US-31**|Editar perfil de usuario|<p>Como usuario, quiero cambiar mi foto o datos de perfil.</p>|<p>**Escenario 1:** Actualización</p><p>Dado que el usuario edita sus datos,</p><p>Cuando da en guardar,</p><p>Entonces la info se actualiza en pantalla.</p>|**EP-04**|
|**US-32**|Eliminar cuenta|<p>Como usuario, quiero borrar definitivamente mi cuenta y datos.</p>|<p>**Escenario 1:** Borrado de datos</p><p>Dado que confirma la eliminación,</p><p>Cuando el sistema procesa,</p><p>Entonces sus datos se borran de MySQL.</p>|**EP-04**|
|**US-33**|Configurar preferencias|<p>Como usuario, quiero elegir qué tipo de alertas me llegan.</p>|<p>**Escenario 1:** Toggle de alertas</p><p>Dado que apaga el switch de reportes,</p><p>Cuando se guarda la preferencia,</p><p>Entonces deja de recibir correos mensuales.</p>|**EP-07**|
|**US-34**|Simular conexión de equipo|<p>Como desarrollador, quiero simular un dispositivo nuevo para pruebas.</p>|<p>**Escenario 1:** Dispositivo virtual</p><p>Dado que se dispara el evento simulador,</p><p>Cuando ocurre la conexión,</p><p>Entonces el equipo aparece en la app.</p>|**EP-01**|
|**US-35**|Simular desconexión|<p>Como usuario, quiero saber si un equipo se ha desconectado.</p>|<p>**Escenario 1:** Estado Offline</p><p>Dado que el equipo pierde conexión,</p><p>Cuando la API no recibe datos,</p><p>Entonces el ícono se pone en Desconectado.</p>|**EP-01**|
|**US-36**|Filtrar historial por fechas|<p>Como usuario, quiero establecer un rango de fechas para ver consumos pasados.</p>|<p>**Escenario 1:** Datepicker</p><p>Dado que el usuario usa el calendario,</p><p>Cuando selecciona el rango,</p><p>Entonces la gráfica se filtra.</p>|**EP-03**|
|**US-37**|Exportar historial a Excel|<p>Como usuario de negocio, quiero descargar mis datos de consumo.</p>|<p>**Escenario 1:** Descarga CSV</p><p>Dado que visualiza la tabla,</p><p>Cuando hace clic en Exportar,</p><p>Entonces se descarga un CSV.</p>|**EP-03**|
|**US-38**|Acceder a FAQs|<p>Como usuario, quiero leer respuestas a problemas comunes.</p>|<p>**Escenario 1:** Sección Ayuda</p><p>Dado que entra a soporte,</p><p>Cuando despliega una pregunta,</p><p>Entonces visualiza la respuesta.</p>|**EP-07**|
|**US-39**|Visualizar gasto en Soles|<p>Como usuario, quiero ver un estimado en dinero de mi consumo en Watts.</p>|<p>**Escenario 1:** Conversión</p><p>Dado que conoce la tarifa,</p><p>Cuando mira el dashboard,</p><p>Entonces ve el costo proyectado en S/.</p>|**EP-03**|
|**US-40**|Agrupar dispositivos|<p>Como usuario, quiero agrupar mis enchufes por habitaciones.</p>|<p>**Escenario 1:** Control Grupal</p><p>Dado que crea el grupo Sala,</p><p>Cuando apaga el grupo,</p><p>Entonces todos los equipos de la sala se apagan.</p>|**EP-02**|
...
| - | - | - | - | - |
|**TS-01**|Maquetación HTML inicial|<p>**Como** desarrollador frontend</p><p>**Quiero** estructurar el HTML de la landing</p><p>**Para** asegurar la semántica (US-21).</p>|<p>**Escenario 1: HTML**</p><p>Dado que se codifica,</p><p>Cuando se crea el index,</p><p>Entonces usa etiquetas semánticas.</p>|**EP-05**|
|**TS-02**|Estilización general|<p>**Como** diseñador UI</p><p>**Quiero** aplicar CSS a la landing</p><p>**Para** cumplir con Figma (US-22).</p>|<p>**Escenario 1: CSS**</p><p>Dado el HTML listo,</p><p>Cuando se aplica estilo,</p><p>Entonces refleja la marca.</p>|**EP-05**|
|**TS-03**|Diseño de navegación|<p>**Como** desarrollador</p><p>**Quiero** crear el menú superior</p><p>**Para** facilitar movilidad (US-25).</p>|<p>**Escenario 1: Links**</p><p>Dado el Navbar,</p><p>Cuando hay enlaces,</p><p>Entonces bajan a la sección.</p>|**EP-05**|
|**TS-04**|Personalización Navbar|<p>**Como** desarrollador</p><p>**Quiero** Navbar dinámico</p><p>**Para** mejor visibilidad (US-25).</p>|<p>**Escenario 1: Scroll**</p><p>Dado que se baja en la web,</p><p>Cuando se detecta scroll,</p><p>Entonces el menú cambia de color.</p>|**EP-05**|
|**TS-05**|Contenido principal responsivo|<p>**Como** desarrollador web</p><p>**Quiero** usar Flexbox/Grid</p><p>**Para** diseño móvil (US-21).</p>|<p>**Escenario 1: Responsive**</p><p>Dado el ancho de móvil,</p><p>Cuando renderiza,</p><p>Entonces se apila en columnas.</p>|**EP-05**|
|**TS-06**|Navbar adaptable|<p>**Como** desarrollador</p><p>**Quiero** menú hamburguesa</p><p>**Para** móviles (US-25).</p>|<p>**Escenario 1: Colapso**</p><p>Dado el modo móvil,</p><p>Cuando presiona el menú,</p><p>Entonces se despliega vertical.</p>|**EP-05**|
|**TS-07**|Setup Spring Boot|<p>**Como** backend developer</p><p>**Quiero** iniciar el servidor Java</p><p>**Para** alojar la API.</p>|<p>**Escenario 1: Deploy**</p><p>Dado el inicio del proyecto,</p><p>Cuando compila,</p><p>Entonces corre en puerto 8080.</p>|**EP-01**|
|**TS-08**|Setup MySQL|<p>**Como** DB Admin</p><p>**Quiero** crear tablas en MySQL</p><p>**Para** persistir usuarios (US-01).</p>|<p>**Escenario 1: Conexión**</p><p>Dado el servicio activo,</p><p>Cuando JPA conecta,</p><p>Entonces se crean esquemas.</p>|**EP-01**|
|**TS-09**|Integración Stripe|<p>**Como** backend</p><p>**Quiero** el SDK de Stripe</p><p>**Para** procesar pagos (US-26).</p>|<p>**Escenario 1: Pago**</p><p>Dado el request de compra,</p><p>Cuando responde 200,</p><p>Entonces se valida el cobro.</p>|**EP-06**|
|**TS-10**|Integración Mailchimp|<p>**Como** backend</p><p>**Quiero** API de Mailchimp</p><p>**Para** enviar correos (US-28).</p>|<p>**Escenario 1: Envío**</p><p>Dado un evento de alerta,</p><p>Cuando se llama a Mailchimp,</p><p>Entonces se despacha el mail.</p>|**EP-07**|
|**TS-11**|Simulación Telemetría|<p>**Como** backend</p><p>**Quiero** un cronjob en Spring</p><p>**Para** generar Watts falsos (US-34).</p>|<p>**Escenario 1: Cronjob**</p><p>Dado el servidor arriba,</p><p>Cuando pasa un minuto,</p><p>Entonces inyecta datos de consumo.</p>|**EP-03**|
|**TS-12**|Endpoints Dispositivos|<p>**Como** backend</p><p>**Quiero** CRUD de equipos</p><p>**Para** manipular enchufes (US-13).</p>|<p>**Escenario 1: GET/POST**</p><p>Dado el endpoint,</p><p>Cuando se pide info,</p><p>Entonces retorna un JSON válido.</p>|**EP-02**|
|**TS-13**|Setup Angular SPA|<p>**Como** frontend</p><p>**Quiero** iniciar Angular</p><p>**Para** hacer el dashboard.</p>|<p>**Escenario 1: App web**</p><p>Dado el comando start,</p><p>Cuando levanta,</p><p>Entonces sirve en puerto 4200.</p>|**EP-01**|
|**TS-14**|Autenticación JWT|<p>**Como** fullstack</p><p>**Quiero** tokens JWT</p><p>**Para** proteger rutas (US-15).</p>|<p>**Escenario 1: Token auth**</p><p>Dado el login correcto,</p><p>Cuando el backend responde,</p><p>Entonces entrega el JWT al front.</p>|**EP-04**|
|**TS-15**|Gráficos en UI|<p>**Como** frontend</p><p>**Quiero** librería Chart.js</p><p>**Para** dibujar consumos (US-09).</p>|<p>**Escenario 1: Canvas**</p><p>Dado el arreglo de datos,</p><p>Cuando renderiza,</p><p>Entonces se muestra la gráfica.</p>|**EP-03**|
|**TS-16**|Configuración User API|<p>**Como** backend</p><p>**Quiero** ruta PUT</p><p>**Para** editar perfil (US-31).</p>|<p>**Escenario 1: PUT Data**</p><p>Dado el request de cambio,</p><p>Cuando valida info,</p><p>Entonces guarda en MySQL.</p>|**EP-04**|
...
|--|--|--|--|--|
| 1 | US-21 | Visualización de la Historia de la Startup | Como visitante, quiero acceder a la historia y misión en la landing page. | 3 |
| 2 | US-22 | Visualizar las características clave | Como visitante, quiero conocer las funciones clave de automatización. | 3 |
| 3 | US-23 | Formulario de contacto | Como visitante, quiero llenar un formulario para recibir noticias. | 2 |
| 4 | US-24 | Ver los planes y precios | Como visitante, quiero acceder a una sección que detalle los planes. | 2 |
| 5 | US-25 | Navegación en la Landing Page | Como visitante, quiero contar con un menú visible y funcional. | 2 |
| 6 | US-01 | Registro inicial del usuario | Como usuario, quiero crear una cuenta en la plataforma. | 3 |
| 7 | US-02 | Emparejar dispositivo plug-and-play | Como usuario, quiero vincular un enchufe inteligente. | 8 |
| 8 | US-03 | Asistente de instalación guiada | Como usuario, quiero seguir un tutorial de primeros pasos. | 5 |
| 9 | US-04 | Nombrar dispositivos | Como usuario, quiero ponerle nombre a mis equipos. | 2 |
| 10 | US-13 | Administrar múltiples dispositivos | Como usuario, quiero ver todos mis equipos en una pantalla. | 5 |
| 11 | US-05 | Ver estado en tiempo real | Como usuario, quiero ver si un dispositivo está ON/OFF. | 3 |
| 12 | US-06 | Encender y apagar remotamente | Como usuario, quiero controlar los equipos desde el móvil. | 5 |
| 13 | US-34 | Simular conexión de equipo | Como desarrollador, quiero simular la conexión de hardware. | 5 |
| 14 | US-35 | Simular desconexión | Como usuario, quiero saber si un equipo se apagó o desconectó. | 3 |
| 15 | US-07 | Programar horarios de encendido | Como usuario, quiero fijar horarios fijos de funcionamiento. | 5 |
| 16 | US-08 | Crear rutinas automáticas | Como usuario, quiero rutinas para apagar todo masivamente. | 5 |
| 17 | US-40 | Agrupar dispositivos | Como usuario, quiero crear grupos por habitación. | 5 |
| 18 | US-09 | Ver consumo en tiempo real | Como usuario, quiero ver los Watts consumidos en vivo. | 5 |
| 19 | US-10 | Consultar historial de consumo | Como usuario, quiero ver gráficos históricos diarios. | 5 |
| 20 | US-39 | Visualizar gasto en Soles | Como usuario, quiero un cálculo estimado del costo en dinero. | 5 |
| 21 | US-17 | Controlar equipos del negocio | Como dueño, quiero apagar equipos de mi local a distancia. | 3 |
| 22 | US-18 | Programar equipos por horario comercial | Como dueño, quiero automatizar el horario de atención. | 5 |
| 23 | US-19 | Revisar consumo por área o equipo | Como dueño, quiero detectar qué área consume más luz. | 5 |
| 24 | US-26 | Pagar suscripción con tarjeta | Como usuario, quiero pagar el plan Premium vía Stripe. | 8 |
| 25 | US-27 | Cancelar suscripción Premium | Como usuario, quiero anular mi suscripción mensual. | 3 |
| 26 | US-11 | Recibir alertas por alto consumo | Como usuario, quiero alertas en la app por picos de Watts. | 3 |
| 27 | US-28 | Recibir alertas por correo | Como usuario, quiero recibir avisos vía Mailchimp. | 5 |
| 28 | US-29 | Recibir reporte mensual | Como usuario, quiero un correo con el resumen de ahorro. | 5 |
| 29 | US-12 | Ver recomendaciones de ahorro | Como usuario, quiero recibir tips para bajar el consumo. | 5 |
| 30 | US-14 | Crear perfiles de acceso | Como administrador, quiero dar acceso limitado a familiares. | 5 |
| 31 | US-20 | Compartir acceso con personal | Como dueño, quiero que mis empleados controlen algunas zonas. | 3 |
| 32 | US-15 | Bloquear acceso no autorizado | Como usuario, quiero que la sesión se cierre por inactividad. | 3 |
| 33 | US-16 | Registrar actividad de control | Como administrador, quiero un historial de quién operó los equipos. | 3 |
| 34 | US-30 | Recuperar contraseña | Como usuario, quiero restablecer mi clave vía email. | 3 |
| 35 | US-31 | Editar perfil de usuario | Como usuario, quiero cambiar mi foto o nombre. | 2 |
| 36 | US-32 | Eliminar cuenta | Como usuario, quiero borrar mis datos de la base de datos. | 3 |
| 37 | US-33 | Configurar preferencias | Como usuario, quiero activar o desactivar emails promocionales. | 2 |
| 38 | US-36 | Filtrar historial por fechas | Como usuario, quiero usar un calendario en los reportes. | 3 |
| 39 | US-37 | Exportar historial a Excel | Como usuario de negocio, quiero exportar la tabla a CSV. | 3 |
| 40 | US-38 | Cambiar idioma de la plataforma | Como usuario, quiero poner el dashboard en inglés. | 5 |
